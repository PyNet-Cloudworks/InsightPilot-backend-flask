...
def annotate_faces_opencv(image_path, output_dir="static/processed_images", return_img=False, auto_cleanup=False):
    os.makedirs(output_dir, exist_ok=True)
    image = cv2.imread(image_path)
    ...
    if auto_cleanup and os.path.exists(image_path):
...
def detect_defects_opencv(image_path, output_dir="static/processed_images", return_img=False, auto_cleanup=False):
    os.makedirs(output_dir, exist_ok=True)
    image = cv2.imread(image_path)
